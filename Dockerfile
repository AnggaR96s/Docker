...
RUN wget -N https://chromedriver.storage.googleapis.com/102.0.5005.61/chromedriver_linux64.zip -P ~/ && \
...
RUN pip3 install --no-cache-dir -r https://raw.githubusercontent.com/AnggaR96s/Docker/kinetic/requirements.txt
